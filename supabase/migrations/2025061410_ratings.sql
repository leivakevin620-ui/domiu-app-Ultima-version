...
CREATE INDEX IF NOT EXISTS idx_ratings_rated_entity_id ON ratings(rated_entity_id);
...
CREATE INDEX IF NOT EXISTS idx_ratings_entity_type ON ratings(rating_type, rated_entity_id, is_public);
...
CREATE INDEX IF NOT EXISTS idx_rating_comments_author_id ON rating_comments(author_id);
...
CREATE INDEX IF NOT EXISTS idx_rating_reactions_rating_id ON rating_reactions(rating_id);
CREATE INDEX IF NOT EXISTS idx_rating_reactions_user_id ON rating_reactions(user_id);
...
DROP TRIGGER IF EXISTS update_rating_comments_updated_at ON rating_comments;
...
DROP TRIGGER IF EXISTS recalculate_rating_on_insert ON ratings;
...
DROP TRIGGER IF EXISTS recalculate_rating_on_update ON ratings;
...
DROP TRIGGER IF EXISTS update_order_rating_trigger ON ratings;
