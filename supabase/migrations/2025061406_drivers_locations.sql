...
DO $$ BEGIN CREATE TYPE driver_status AS ENUM ('available', 'busy', 'offline', 'on_break'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE vehicle_type AS ENUM ('bike', 'motorcycle', 'car', 'van'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DROP TRIGGER IF EXISTS update_driver_location_trigger ON driver_locations;
...
DROP TRIGGER IF EXISTS cleanup_driver_locations_trigger ON driver_locations;
