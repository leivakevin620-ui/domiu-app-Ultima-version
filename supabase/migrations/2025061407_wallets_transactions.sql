...
DO $$ BEGIN CREATE TYPE transaction_type AS ENUM ('credit', 'debit', 'refund', 'bonus', 'adjustment'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
DO $$ BEGIN CREATE TYPE wallet_transaction_status AS ENUM ('pending', 'completed', 'failed', 'refunded'); EXCEPTION WHEN duplicate_object THEN NULL; END $$;
...
DROP TRIGGER IF EXISTS update_wallet_topups_updated_at ON wallet_topups;
