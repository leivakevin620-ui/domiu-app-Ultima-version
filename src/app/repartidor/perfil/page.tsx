...
import { User, Mail, Phone, Shield, Truck } from 'lucide-react';
...
export default function RepartidorPerfil() {
  ...
  return (
    <PageContainer>
        ...
        <dl className="grid gap-4 sm:grid-cols-2">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <dd className="text-sm text-foreground">Repartidor</dd>
            </div>
          </div>
        </dl>
      </DashboardCard>
      ...
      <div className="mt-6">
        <DashboardCard title="Vehículo">
          <div className="flex flex-col items-center gap-2 py-4 text-center">
            <Truck className="h-8 w-8 text-muted-foreground" />
            <p className="text-sm text-muted-foreground">No has registrado un vehículo aún</p>
          </div>
        </DashboardCard>
      </div>
    </PageContainer>
