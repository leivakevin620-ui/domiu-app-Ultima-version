    ...
    <div className="space-y-6">
      ...
      <div className="rounded-xl border border-border bg-card p-4 space-y-3">
        ...
        {owner ? (
          <div className="flex items-start gap-4">
            ...
            <button onClick={() => toast.info('Función en preparación: restablecimiento de acceso')} className="shrink-0 rounded-lg border border-border px-3 py-2 text-xs text-foreground/80 hover:text-foreground transition-colors">
      ...
      <div className="rounded-xl border border-border bg-card p-4 space-y-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          ...
          <button onClick={() => toast.info('Función en preparación: asociar usuario existente')} className="rounded-lg border border-border bg-card p-4 text-left hover:border-success/30 transition-all group">
          ...
          <button onClick={() => toast.info('Función en preparación: restablecer contraseña')} className="rounded-lg border border-border bg-card p-4 text-left hover:border-success/30 transition-all group">
